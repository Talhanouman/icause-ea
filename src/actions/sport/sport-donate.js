...
export const getOrganization = (charity_id, from) => (dispatch) => {
  dispatch({
    type: 'GET_ORGANIZATION_BY_ID_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    ...
    const { charity } = data || {};
    return dispatch({
      type: 'GET_ORGANIZATION_BY_ID_FOR_DONATE_SUCCESS',
      payload: {
    ...
    return dispatch({
      type: 'GET_ORGANIZATION_BY_ID_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}

export const payByBill = ({ company_id, email, first_name, last_name, phone_number, method, billFile, images, values }) => (dispatch) => {
...
export const getFeaturedIndustries = (industry) => (dispatch, getState) => {
  dispatch({
    type: 'GET_FEATURED_ORGANIZATIONS_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    ...
    const { charity } = data;
    return dispatch({
      type: 'GET_FEATURED_ORGANIZATIONS_FOR_DONATE_SUCCESS',
      payload: {
        loading: false,
    ...
    notification.error({
      message: 'GET FEATURED ORGANIZATIONS',
      description: error.message
    });

    return dispatch({
      type: 'GET_FEATURED_ORGANIZATIONS_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}
...
export const likeCompanyType = (campaign_id, status, type, userOrBrowserInfo) => (dispatch) => {
  dispatch({
    type: 'LIKE_COMPANY_ORGANIZATION_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    url: '/api/like',
    ...
    return dispatch({
      type: 'LIKE_COMPANY_ORGANIZATION_FOR_DONATE_SUCCESS',
      payload: {
        loading: false
      }
    });
    ...
    return dispatch({
      type: 'LIKE_COMPANY_ORGANIZATION_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}
...
export const shareCompany = (from, to, shared_on) => (dispatch, getState) => {
  dispatch({
    type: 'SHARE_ORGANIZATION_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    url: '/api/share',
    ...
    return dispatch({
      type: 'SHARE_ORGANIZATION_FOR_DONATE_SUCCESS',
      payload: {
        loading: false
      }
    });
    ...
    return dispatch({
      type: 'SHARE_ORGANIZATION_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}