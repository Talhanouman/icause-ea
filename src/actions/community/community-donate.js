...
export const getCommunity = (charity_id, from) => (dispatch) => {
  dispatch({
    type: 'GET_COMMUNITY_BY_ID_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    ...
    const { charity } = data || {};
    return dispatch({
      type: 'GET_COMMUNITY_BY_ID_FOR_DONATE_SUCCESS',
      payload: {
        community: charity,
        loading: false
      }
    ...
    return dispatch({
      type: 'GET_COMMUNITY_BY_ID_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}
...
export const getFeaturedIndustries = (industry) => (dispatch, getState) => {
  dispatch({
    type: 'GET_FEATURED_COMMUNITIES_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    ...
    const { charity } = data;
    return dispatch({
      type: 'GET_FEATURED_COMMUNITIES_FOR_DONATE_SUCCESS',
      payload: {
        loading: false,
    ...
    return dispatch({
      type: 'GET_FEATURED_COMMUNITIES_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}
...
export const likeCompanyType = (campaign_id, status, type, userOrBrowserInfo) => (dispatch) => {
  dispatch({
    type: 'LIKE_COMPANY_COMMUNITY_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    url: '/api/like',
    ...
    return dispatch({
      type: 'LIKE_COMPANY_COMMUNITY_FOR_DONATE_SUCCESS',
      payload: {
        loading: false
      }
    });
    ...
    return dispatch({
      type: 'LIKE_COMPANY_COMMUNITY_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}
...
export const shareCompany = (from, to, shared_on) => (dispatch, getState) => {
  dispatch({
    type: 'SHARE_COMMUNITY_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    url: '/api/share',
    ...
    return dispatch({
      type: 'SHARE_COMMUNITY_FOR_DONATE_SUCCESS',
      payload: {
        loading: false
      }
    });
    ...
    return dispatch({
      type: 'SHARE_COMMUNITY_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}