...
export const payByBill = ({ campaigns_id, email, first_name, last_name, phone_number, method, billFile, amount, company_id, type, images, values }) => (dispatch) => {
...
export const getSchool = (charity_id, from) => (dispatch) => {
  dispatch({
    type: 'GET_SCHOOL_BY_ID_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    ...
    const { charity } = data || {};
    return dispatch({
      type: 'GET_SCHOOL_BY_ID_FOR_DONATE_SUCCESS',
      payload: {
        school: charity,
        loading: false
      }
    ...
    return dispatch({
      type: 'GET_SCHOOL_BY_ID_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}
...
export const getFeaturedIndustries = (industry) => (dispatch, getState) => {
  dispatch({
    type: 'GET_FEATURED_SCHOOLS_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    ...
    const { charity } = data;
    return dispatch({
      type: 'GET_FEATURED_SCHOOLS_FOR_DONATE_SUCCESS',
      payload: {
        loading: false,
    ...
    notification.error({
      message: 'GET FEATURED SCHOOLS',
      description: error.message
    });

    return dispatch({
      type: 'GET_FEATURED_SCHOOLS_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}
...
export const likeCompanyType = (campaign_id, status, type, userOrBrowserInfo) => (dispatch) => {
  dispatch({
    type: 'LIKE_COMPANY_SCHOOL_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    url: '/api/like',
    ...
    return dispatch({
      type: 'LIKE_COMPANY_SCHOOL_FOR_DONATE_SUCCESS',
      payload: {
        loading: false
      }
    });
    ...
    return dispatch({
      type: 'LIKE_COMPANY_SCHOOL_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}
...
export const shareCompany = (from, to, shared_on) => (dispatch, getState) => {
  dispatch({
    type: 'SHARE_SCHOOL_FOR_DONATE_REQUEST',
    payload: { loading: true }
  });
  return axios({
    url: '/api/share',
    ...
    return dispatch({
      type: 'SHARE_SCHOOL_FOR_DONATE_SUCCESS',
      payload: {
        loading: false
      }
    });
    ...
    return dispatch({
      type: 'SHARE_SCHOOL_FOR_DONATE_FAILED',
      payload: { loading: false }
    });
  })
}