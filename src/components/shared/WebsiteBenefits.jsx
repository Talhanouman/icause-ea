...
const WebsiteBenefits = () => {
  return (
    <div>
      <section className="Best-fundraising-website event-manager-sec-7 pt-md-5">
        <div className="services">
          <div className="container container-lg">
          <h2 className="main-heading text-center pb-2 mb-1"> A crowdfunding platform for everyone </h2>
          <p style={{ color: 'black' }} className="gen-text mb-3 text-md-center text-left">   We’re not just another fundraising platform, we’re the whole package!</p>
       
            {/* <h2 className="main-heading text-center pb-2 mb-1">Best fundraising platform </h2> */}
            {/* <p style={{ color: 'black' }} className="gen-text mb-3 text-md-center text-left">Not convinced that Icause is the best fundraising and crowdfunding website? Just check out the following reasons.</p> */}
            
            <div className="row">
              <div className="col-6 col-sm-6 col-md-6 col-lg-4 mb-3 benefits-col">
                <div className="box p-4">
                  ...
                  {/* <h3>Australian owned & operated</h3>
                  <p style={{ color: 'black' }}>Icause is 100% Australian owned and operated including our call center.
                        </p> */}
                </div>
              </div>
              <div className="col-6 col-sm-6 col-md-6 col-lg-4 mb-3 benefits-col">
                <div className="box p-4">
                  ...
                  {/* <h3 style={{ color: 'black' }}>Donate using your bill  </h3>
                  <p style={{ color: 'black' }}>Icause allows you to donate money using your bill. </p> */}
                </div>
              </div>
              <div className="col-6 col-sm-6 col-md-6 col-lg-4 mb-3 benefits-col">
                <div className="box p-4">
                  ...
                  {/* <h3 style={{ color: 'black' }}>More Payment Options </h3>
                  <p style={{ color: 'black' }}> Icause provides secure payment methods with Master, Visa, Amex, Google Pay, Apple Pay, PayPal, with Master Card etc. </p> */}
                </div>
              </div>
              <div className="col-6 col-sm-6 col-md-6 col-lg-4 mb-3 benefits-col">
                <div className="box p-4">
                  ...
                  {/* <h3 style={{ color: 'black' }}>Simple and easy to use</h3>
                  <p style={{ color: 'black' }}>Easy to set up a campaign, donate money and more with 24 hours support.</p> */}
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-6 col-lg-4 mb-3 benefits-col">
                <div className="box p-4">
                  ...
                  {/* <h3 style={{ color: 'black' }}>Free mobile app</h3>
                  <p style={{ color: 'black' }}>You are in complete control.  Simply launch and manage your fundraiser on the go.</p> */}
                </div>
              </div>
              <div className="col-6 col-sm-6 col-md-6 col-lg-4 mb-3 benefits-col">
                <div className="box p-4">
                  ...
                  {/* <h3 style={{ color: 'black' }}>Complete Marketing tool</h3>
                  <p style={{ color: 'black' }}>Manage your campaigns easily and send invitations via SMS and Email. </p> */}
                </div>
              </div>
