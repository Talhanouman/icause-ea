...
const SubCategoryDetails = (props) => {
  ...
  const { params } = match || {};
  const subCategoryId = params && params.id ? Number(params.id) : null;
  ...
  let subCategoryImage = `${imageURL}boy.PNG`;
  if (img) {
    ...
    <div>
      <Spin spinning={loading}>
          ...
          <div className='container'>
            <div className='row align-items-center  '>
              <div className='col-lg-6 col-md-12  '>
                <h3 dangerouslySetInnerHTML={{ __html: title || '' }} className="main-heading mt-4 mt-md-0">
                </h3>
                <p style={{ color: 'black' }} className='mt-4 pt-2'>{text1}</p>
                <p style={{ color: 'black' }} className=' pt-2'>{text2}</p>
                <p style={{ color: 'black' }}>{text3}</p>
              </div>
              <div className='col-lg-6 col-md-12 text-center'> 
                <img style={{ height: '344px' }} className='img-fluid' src={subCategoryImage} alt='donate' /> 
              </div>
            </div>
          </div>
        </section>
        <FeaturedCampaigns 
          ...
          loading={loading}
        />
        <section className="Best-fundraising-website">
          <div className="services">
            <div className="container">
              <h2 className="main-heading text-center pb-5">Best fundraising website</h2>
              <div className="row">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="66" height="54.708" viewBox="0 0 66 54.708" className="mb-3">
                      <g id="XMLID_2177_" transform="translate(0.001 -43.8)">
                        <g id="XMLID_707_" transform="translate(-0.001 43.8)">
                          ...
                          <path id="XMLID_718_" d="M153.667,178.521a1.308,1.308,0,1,0-.926-.384A1.323,1.323,0,0,0,153.667,178.521Z" transform="translate(-132.731 -158.886)" /> </g>
                      </g>
                    </svg>
                    <h4>Australia owned</h4>
                    <p style={{ color: 'black' }}>Lorem ipsum dolor sit amet, consectetur adipis cido Donec et sem laoreet, porta quam. </p>
                  </div>
                </div>
                <div className="col-md-6 col-lg-4 mb-3">
                  <div className="box p-4">
                    <svg id="wireframe" xmlns="http://www.w3.org/2000/svg" width="55.894" height="54.708" viewBox="0 0 55.894 54.708" className="mb-3">
                      ...
                      <g id="Group_89" data-name="Group 89" transform="translate(33.882 33.017)">
                        <g id="Group_88" data-name="Group 88">
                          <path id="Path_1304" data-name="Path 1304" d="M319.891,309H307.069a1.069,1.069,0,1,0,0,2.137h12.822a1.069,1.069,0,0,0,0-2.137Z" transform="translate(-306 -309)" /> </g>
                      </g>
                      <g id="Group_91" data-name="Group 91" transform="translate(33.882 39.428)">
                        <g id="Group_90" data-name="Group 90">
                          <path id="Path_1305" data-name="Path 1305" d="M319.891,369H307.069a1.069,1.069,0,1,0,0,2.137h12.822a1.069,1.069,0,0,0,0-2.137Z" transform="translate(-306 -369)" /> </g>
                      </g>
                      <g id="Group_93" data-name="Group 93" transform="translate(33.882 45.839)">
                        <g id="Group_92" data-name="Group 92">
                          <path id="Path_1306" data-name="Path 1306" d="M319.891,429H307.069a1.069,1.069,0,1,0,0,2.137h12.822a1.069,1.069,0,1,0,0-2.137Z" transform="translate(-306 -429)" /> </g>
                      </g>
                    </svg>
                    <h4>Easy to use</h4>
                    <p style={{ color: 'black' }}>Lorem ipsum dolor sit amet, consectetur adipis cido Donec et sem laoreet, porta quam. </p>
                  ...
                  <div className="box p-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48.823" height="60" viewBox="0 0 48.823 60" className="mb-3">
                      <g id="outline" transform="translate(-7.177 -2)">
                        ...
                        <path id="Path_1318" data-name="Path 1318" d="M31,44h2v2H31Z" /> </g>
                    </svg>
                    <h4>Get free app</h4>
                    <p style={{ color: 'black' }}>Lorem ipsum dolor sit amet, consectetur adipis cido Donec et sem laoreet, porta quam. </p>
                  </div>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="58.044" height="56.333" viewBox="0 0 58.044 56.333" className="mb-3">
                      <g id="_07-Credit_card_discount" data-name="07-Credit card discount" transform="translate(-4 -15.528)">
                        <g id="filled" transform="translate(4 15.528)">
                          ...
                          <circle id="Ellipse_7" data-name="Ellipse 7" cx="1.382" cy="1.382" r="1.382" transform="translate(30.266 38.559)" /> </g>
                      </g>
                    </svg>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="62.81" height="62.993" viewBox="0 0 62.81 62.993" className="mb-3">
                      <g id="donate" transform="translate(-0.745)">
                        <g id="Group_112" data-name="Group 112" transform="translate(0.745)">
                          ...
                          <path id="Path_1340" data-name="Path 1340" d="M246.308,49.2a1.308,1.308,0,1,0,.482-1.589A1.319,1.319,0,0,0,246.308,49.2Z" transform="translate(-216.089 -41.191)" /> </g>
                      </g>
                    </svg>
                    <h4>Donate using bill or money</h4>
                    <p style={{ color: 'black' }}>Lorem ipsum dolor sit amet, consectetur adipis cido Donec et sem laoreet, porta quam. </p>
                  </div>
                </div>
              </div>
