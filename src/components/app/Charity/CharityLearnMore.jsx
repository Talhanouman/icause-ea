...
const CharityLearnMore = (props) => {
  ...
  return (
    <div className="poppin-wrap">
      ...
      <section className="banner learn-more-charity-banner gen-banner">
            ...
            <div className="col-12">
              <div className="banner-text-box-learn-more">
                ...
                Support your members while they support you
                  {/* Learn More Ways To Fundraise for Your Favourite Charity */}
                  </p>
      ...
      <section className="security-guarante">
        <div className="container learn-charity">
            ...
            <div className="row">
              <div className="col-12 col-md-6 col-lg-5">
                <div className="p-3">
                  ...
                  <p>
                  We want to help your charity by providing a powerful online fundraising tool that will help you reach your supporters in a brand-new way. 
                  ...
                  <p>We know that your passionate supporters aren’t always in the position to donate funds, that’s why we’ve created an alternative - we’re the only platform that offers the choice to donate directly or to use a bill to donate. By donating with a bill, your supporters might even make a saving for themselves – it’s a win-win!</p>
                  <p
              ...
              <div className="col-12 col-md-6 col-lg-7">
                <VideoPlayer
                  videoId={"j7KKZ6v5o34"}
                  basePath={`${imageURLS3}learn_more/charity/`}
                  image={"video.jpeg"}
                />
              </div>
            </div>
      ...
      <section className="choose-charity-fun">
        <div className="container">
          ...
          Fundraising with a difference
            {/* Choose a charity creating your charity fundraiser */}
          </h1>
          <div className="row">
            <div className="col-12 col-md-9 mx-auto">
              <div className="row m-sm-0">
                ...
                <div className="col-md-4 col-12 text-md-center mt-4">
                  ...
                  <p>
                    In a few easy steps, your Charity fundraiser will be up and
                    running.
                  </p>
                </div>
                <div className="col-md-4 col-12 text-md-center mt-4">
        ...
        <div className="container bg-white">
          <div className="row ">
            <div className="col-12 col-md-4 col-lg-4 pl-md-0">
              <img
                src={`${imageURLS3}learn_more/charity/small+imag.jpg`}
                alt=""
      ...
      <section className="school-fundraising learn-chirty">
        <div className="">
          <div className="row mx-0 ">
            <div className="col-12 offset-lg-1  col-md-12 col-lg-5 px-lg-0 iCause-Partners">
              <div className="pr-md-4">
                ...
                <ul>
                  <p style={{ color: "black" }}>
                  We can help you inspire and motivate your supporters so you can reach your goals faster. Here are some great reasons to choose icause:
                    {/* We've made it easier and better by giving you a complete
                    fundraising platform that is easy to use and enables you to: */}
                  </p>
                  <li>
                  	We’ve created a unique way for your supporters to donate – either donate directly in a few simple clicks or use a utility bill to donate. 
                    {/* Inspire your friends and family through your crowdfunding
                    page and use the Platform to reach them with your unique
                    link. */}
                  </li>
                  <li>
                  	Keep track of your goals - our online portal gives you complete control over your fundraising. 
                    {/* A new way to donate – your supporters can donate directly or
                    upload a bill to support. We are the only crowdfunding
                    platform in the world that offers bill donations. Find out
                    more here. */}
                  </li>
                  <li>
                    ...
                    paid to your chosen Charity at the close of your Campaign.{" "} */}
                  </li>
                  <li>
                  It’s easy! The funds you raise will automatically be paid into your nominated bank account at the end of your campaign.
                    {/* A personal online portal to share your story, reach your
                    supporters and track your progress. */}
                  </li>
                </ul>
              </div>
            ...
            <div className="col-12 col-md-12 col-lg-6 px-md-0">
              <div className="">
                <img
                  src={`${imageURLS3}learn_more/charity/shutterstock_1396177793.jpg`}
                  alt=""
                  className="w-100"
                ></img>
              </div>
        ...
        <div className="container text-center">
          <div className="row">
            <div className="col-lg-10 col-md-12 mx-auto">
              <h1>
              What are you waiting for? <span> We’re here to help you make a change.</span>
...
export default CharityLearnMore;
