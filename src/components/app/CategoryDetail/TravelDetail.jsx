		...
		<div className="new-cate-wrap">
            <section className="banner gen-banner new-cate-banner">
                ...
                <OwlCarousel className="owl-carousel owl-theme about-banner-slider news-banner-slider" loop={true} margin={0} dots={true} responsive={{ 0: { items: 1 } }} nav={true}>
                    <div className="item item-1" style={{ backgroundImage: `url(${imageURL}"travel-cat-banner.jpg")` }}>
          ...
          <div className='container'>
            <div className='row d-flex align-items-end  '>
              ...
              <div className='col-lg-5 col-md-5 trending-causes p-0 height-100'>
                <div className="card d-flex justify-content-end align-items-end m-0"> <img style={{ height: '416px', width: '344px' }} src={`${imageURL}travel-3-img.png`} className="img-fluid" alt="" /> </div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="trending-causes school-list-sec-3 pt-0 pb-0 pt-4">
					<div className="container">
                      ...
                      <div className="card trending-cause-card trending-cause-card-2">
												<div className="img">
													<img src={`${imageURL}travel-card-1.jpg`} className="img-fluid" alt="" />
                      ...
                      <div className="card trending-cause-card trending-cause-card-2">
												<div className="img">
                          <img src={`${imageURL}travel-card-2.jpg`} className="img-fluid" alt="" />
													<a href="#!" style={{ textAlign: 'center', paddingTop: 14 }} className="donate-btn">DONATE NOW</a>
												</div>
												<div className="desc">
													<div className="text-card"> <span>Los angeles</span> <span>5 days left</span> </div>
                      ...
                      <div className="card trending-cause-card trending-cause-card-2">
												<div className="img">
                          <img src={`${imageURL}travel-card-3.jpg`} className="img-fluid" alt="" />
													<a href="#!"  style={{ textAlign: 'center', paddingTop: 14 }} className="donate-btn">DONATE NOW</a>
												</div>
												<div className="desc">
													<div className="text-card"> <span>Los angeles</span> <span>5 days left</span> </div>
