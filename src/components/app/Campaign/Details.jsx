...
const CampaignDetails = (props) => {
	...
	const { weeks_left, shares, likeCount, cover_photo, funded, amount, title, id, progress, story, short_story } = campaignDetail || {};
	...
	const copyCamp= ()=>{
		let myCamp = document.getElementById("camp").innerHTML;
		navigator.clipboard.writeText(myCamp)
		...
		<>
			...
			<div className="cam-det-pg-wrap campgion-det-breadcrum">
				...
				<Spin spinning={loading}>
					<section id="camp"  className="pledge-of-the-day bg-white campaignSec1">
						<div className="container">
							<div className="row" id="compaign">
								<div className="col-lg-7 col-md-12 col-sm-12">
									...
									<div className="campaignSec1-left">
										...
										<p className="title" data-tip="Campaign Name">{title}</p>
										<ReactTooltip />
										...
										<div className="campaign-detail">
											...
											<p dangerouslySetInnerHTML={{ __html: formattedShortStory || 'N/A' }}></p>
											{
												...
												<div onClick={() => setDescriptionExpansion(!isDescriptionExpanded)} style={{ border: '0px solid', background: 'none' }} className="readmore">
												...
												<div className="form-row align-items-center mx-0">
													<div className="form-group col-sm-6 pl-0">
														<div className="custom-control custom-switch">
															...
															{/* <label className="custom-control-label" htmlFor="customSwitch1">Post anonymously</label> */}
														</div>
													</div>
								...
								<div className="col-lg-5 col-md-12 col-sm-12">
									<div className="campaignSec1-text">
										...
										<div className="donation-info-wrap">
											...
											<div className="btns-wrap btns-wrap-2 mt-4 px-2">
												<button
				...
				<ReviewCampaignModal
					...
					setReviewModalVisibility={setReviewModalVisibility}
				/>
			</div>
		</>
	);
